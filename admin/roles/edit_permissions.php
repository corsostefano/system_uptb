...
include ('../../app/controllers/roles/data_permissions.php')
?>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body">
                            <form action="<?=APP_URL;?>/app/controllers/roles/update_permissions.php" method="post" >
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="name_url">Nombre de la URL</label>
                                            <input type="hidden" name="id_permission" value="<?=$id_permission?>">
                                            <input type="text" name="name_url" class="form-control" value="<?=$name_url;?>" >                
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
