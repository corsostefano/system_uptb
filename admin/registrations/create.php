...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container">
            <div class="row">
                <h1>Inscripción de un estudiante</h1>
            </div>
            <br>
            <div class="row">
                <br>
                <div class="col-md-12">
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body">
                            <form action="<?=APP_URL;?>/app/controllers/registrations/create.php" method="post" enctype="multipart/form-data" id="user-form">
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-inline">
                                                <select name="rol_id" id="rol_id" class="form-control" onchange="updateCategoryAdmin()">
                                                    <?php foreach ($roles as $role) {
                                                        // Excluir roles de categoría 'estudiante' y 'docente'
                                                        if ($role['category'] !== 'teacher' && $role['category'] !== 'admin') { ?>
                                ...
                                <h4 class="mb-3 text-center">Información de carrera o PNF a cursar</h4>
                                <div class="row mb-3">
                                    <!-- Carrera o PNF -->
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="academic_program_id">Carrera o PNF</label>
                                            <select name="academic_program_id" id="id_academic_programs" class="form-control w-100">
                                                <?php foreach ($programs as $program) { ?>
                                                    <option value="<?=$program['id_academic_programs'];?>">
                                                        <?=$program['programs_name'].' - '.$program['shift'];?>
                                                    </option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="level_id">Año y sección</label>
                                            <select name="level_id" id="id_levels" class="form-control w-100">
                                                <?php foreach ($levels as $level) { ?>
                                                    <!-- Incluimos la clave foránea academic_programs_id -->
                                                    <option value="" disabled selected>Selecciona un año</option>
                                                    <option value="<?=$level['id_levels'];?>" data-academic-program="<?=$level['academic_programs_id'];?>">
                                                        <?=$level['years_level'].' - '.$level['section'];?>
                                                    </option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="id_campuses">Sede</label>
                                            <select name="campus_id" id="id_campuses" class="form-control w-100">
                                ...
                                <div class="row mb-3 text-center">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <a href="<?=APP_URL;?>/admin/students" class="btn btn-secondary">Cancelar</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
<script src="../../public/js/registrations_students.js"></script>
