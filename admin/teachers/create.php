            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body">
                            <form action="<?=APP_URL;?>/app/controllers/teachers/create.php" method="post" enctype="multipart/form-data" id="user-form">
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                            ...
                                            <div class="form-inline">
                                                <select name="rol_id" id="rol_id" class="form-control" onchange="updateCategoryAdmin()">
                                                    <?php foreach ($roles as $role) {
                                                        ...
                                                        if ($role['category'] !== 'student' && $role['category'] !== 'admin') { ?>
                                ...
                                <div class="row mb-3" >
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="specialty" placeholder="Ingresa la especialidad" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label  for="seniority">Antigüedad (en años):</label>
                                            <input type="number" class="form-control" id="seniority" name="seniority" min="0" max="50" placeholder="Años de antigüedad">
                                        </div>
                                    </div>
                                </div>
...
<script src="../../public/js/create_teachers.js"></script>
