...
include ('../../app/controllers/users/data_user.php');
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-outline card-success">
                        ...
                        <div class="card-body">
                            <form action="<?=APP_URL;?>/app/controllers/users/update.php" method="post" enctype="multipart/form-data" id="user-form">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-inline">
                                                ...
                                                <a href="<?=APP_URL;?>/admin/roles/create.php" class="btn btn-success btn-sm" style="margin-left: 5px" data-bs-toggle="tooltip" data-bs-placement="top" title="Crear nuevo rol">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" name="user_password" placeholder="Deja en blanco si no deseas cambiarla">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="user_password_repeat">Confirma tu Nueva Contraseña</label>
                                            <input type="password" class="form-control" name="user_password_repeat" placeholder="Deja en blanco si no deseas cambiarla" >
                                        </div>
                                    </div>
                                </div>
