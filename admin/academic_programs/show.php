        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <h1>Gestión Universitaria: <?=$programs_name;?></h1>
                </div>
            </div>
            <br>
                    ...
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="management">Nombre de PNF</label>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="management">Nombre la gestión</label>
                            ...
                            <div class="row mb-3 text-center">
                                <div class="col-md-12">
                                    <a href="<?=APP_URL;?>/admin/academic_programs" class="btn btn-secondary">Volver</a>
                                </div>
                            </div>
