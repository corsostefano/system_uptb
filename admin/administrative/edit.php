...
include ('../../app/controllers/administrative/data_administrative.php');
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-outline card-success">
                        ...
                        <div class="card-body">
                            <form action="<?=APP_URL;?>/app/controllers/administrative/update.php" method="post" enctype="multipart/form-data" id="user-form">
                                ...
                                <div class="row row mb-3 text-center">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <a href="<?=APP_URL;?>/admin/administrative" class="btn btn-secondary">Cancelar</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
