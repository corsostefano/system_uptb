...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container">
            <div class="row">
                <h1>Creación de un administrativo</h1>
            </div>
            <br>
            <div class="row">
                <br>
                <div class="col-md-12">
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body">
                            <form action="<?=APP_URL;?>/app/controllers/administrative/create.php" method="post" enctype="multipart/form-data" id="user-form">
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                            ...
                                            <div class="form-inline">
                                                <select name="rol_id" id="rol_id" class="form-control" onchange="updateCategoryAdmin()">
                                                    <?php foreach ($roles as $role) {
                                                        ...
                                                        if ($role['category'] !== 'student' && $role['category'] !== 'teacher') { ?>
...
<script src="../../public/js/create_administrative.js"></script>
