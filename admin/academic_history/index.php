                                        ...
                                        ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align:center">
                                                            <a href="create.php?<?php echo htmlspecialchars($queryString); ?>" style="background-color: #dd3e6d" class="btn btn-sm">
                                                            <i class="bi bi-people-fill"></i> Listado de Estudiantes
                                                            </a>
                                                        </td>
                                                    </tr>
                                        <?php 
