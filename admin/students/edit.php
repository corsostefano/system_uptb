...
include ('../../app/controllers/students/data_students.php');
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-outline card-success">
                        ...
                        <div class="card-body">
                            <form action="<?=APP_URL;?>/app/controllers/students/update.php" method="post" enctype="multipart/form-data" id="user-form">
                                            ...
                                            <div class="form-inline">
                                                <select name="rol_id" id="rol_id" class="form-control" onchange="updateCategory()">
                                                    <?php foreach ($roles as $role): ?>
                                                        <?php if ($role['name_rol'] == 'ESTUDIANTE'): // Mostrar solo "docente" ?>
                                            ...
                                            <select name="academic_program_id" id="id_academic_programs" class="form-control w-100">
                                                <?php foreach ($programs as $program) { ?>
                                                    <option value="<?=$program['id_academic_programs'];?>" 
                                                        <?php if ($program['id_academic_programs'] == $user['academic_program_id']) echo 'selected'; ?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="level_id" id="id_levels" class="form-control w-100">
                                                ...
                                                <?php foreach ($levels as $level) { ?>
                                                    <!-- Aquí asignamos el valor por defecto para el nivel -->
                                                    <option value="<?=$level['id_levels'];?>" 
                                                        <?php if ($level['id_levels'] == $user['level_id']) echo 'selected'; ?>
                                                        data-academic-program="<?=$level['academic_programs_id'];?>">
...
<script src="../../public/js/edit_students.js"></script>
