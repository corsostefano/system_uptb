        ...
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-12 text-center">
                    <h1>Usuario Estudiante: <?=$first_name . ' ' . $last_name;?></h1>
                </div>
            </div>
                    ...
                    <div class="card card-outline card-info">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3 text-center">
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        <label><strong>Carrera o PNF:</strong></label>
                            ...
                            <div class="row mb-3 text-center">
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <p class="text-muted">Sección - <?=$section;?></p>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        <label><strong>Sede Universitaria:</strong></label>
                                        <p class="text-muted"><?=$campus_name;?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 text-center">
                                <div class="col-12 text-center mt-4">
                                    <a href="<?=APP_URL;?>/admin/students" class="btn btn-secondary">Volver</a>
                                </div>
                            </div>
                        </div>
                    </div>
