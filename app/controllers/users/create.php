...
$rol_category = $_POST['rol_category']; // Nueva variable recibida desde el formulario
$phone = $_POST['phone'];
$mobile = $_POST['mobile'];
...
if ($first_name_post == '' || $last_name_post == '' || $rol_id == '' || $email == '' || $identification_type == '' || $cedula == '' || $sex == '' || $marital_status == '' || $university_campus == '' || $education == '' || $profession == '' || $address_user == '' || $state_of_residence == '' || $municipality == '' || $user_password == '' || $user_password_repeat == '' || $rol_category == '' || $phone == '' || $mobile == '' || $emergency_contact == '')  {
    session_start();
    $_SESSION['message'] = "Error en Registro, por favor complete todos los campos";
    $_SESSION['icon'] = "error";
    header('Location: ' . APP_URL . "/admin/users/create.php");
    exit(); 
} else {
    ...
    $judgment = $pdo->prepare('INSERT INTO users(first_name, last_name, rol_id, email, identification_type, cedula, sex, birth_date, marital_status, university_campus, education, profession, address_user, state_of_residence, municipality, user_password, profile_picture, fyh_creation, user_state, phone, mobile, emergency_contact) 
    VALUES (:first_name, :last_name, :rol_id, :email, :identification_type, :cedula, :sex, :birth_date, :marital_status, :university_campus, :education, :profession, :address_user, :state_of_residence, :municipality, :user_password, :profile_picture, :fyh_creation, :user_state, :phone, :mobile, :emergency_contact)');
